  ...
  return (
    ...
    >
      ...
      <Container verticalSpace={6} gutterSpace={4}>
        ...
        >
          <Heading as="h2" variant="headline" sx={{mb: 3}}>Music is better together</Heading>
          <Text
            as="p"
            variant="intro"
          >
      ...
      >
        <Box mb={3}>
          <Heading as="h2" variant="subHeadline">We want to love remote work</Heading>
        </Box>
        ...
        <Text
          ...
          variant="body"
        >
          Musicbox helps teams build stronger connections with each other by creating a shared environment for them to listen, share, and discuss music together. This environment, and the conversations that stem from it, offer a remote-friendly way to discover the  -- not the Slack avatars -- that you work with.
        </Text>

        <Box mb={3}>
          <Heading as="h2" variant="subHeadline">Why personal connections matter</Heading>
        </Box>
        ...
        <Box mb={3}>
          <Heading as="h2" variant="subHeadline">You can’t copy &amp; paste a physical office</Heading>
        </Box>
        ...
        >
          <Text
            as="p"
            variant="body"
            sx={{color: 'indigo600', fontSize: 3, lineHeight: 1.5, mb: 3,}}
          >
            So, if you work on a remote team, if you love music, if any part of our notes have resonated with you, we’d love to talk. Please send us an email at <Box as="a" href="mailto:hello@musicbox.fm" sx={{color: 'indigo600', fontWeight: 600}}>hello@musicbox.fm</Box> and we'll get you jamming in no time.
          </Text>
        </Box>
      ...
      <Box as="footer" bg="gray900">
        <Text
          as="p"
          sx={{ color: 'gray200', fontSize: [3,4,5], m: 0, textAlign: 'center'}}
        >
