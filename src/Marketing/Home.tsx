      ...
      >
        <Container verticalSpace={[4, 5, 6]}>
          <Box sx={{ textAlign: 'center'}}>
            ...
            <Text as='p' sx={{ fontSize: [3, 4, 5], color: 'gray700', mb: 4, mx: 'auto', width: ['100%', '80%', '70%'] }}>
              Because you can't copy and paste your physical office and expect the same results. Musicbox takes a remote first approach to connecting with your co-workers.
            </Text>
          </Box>
        ...
        <Container verticalSpace={[4, 5, 6]}>
          <Flex alignItems="center" flexDirection={['column', 'row', 'row']}>
            ...
            >
              ...
              <Text sx={{ fontSize: [3, 4, 5], color: 'gray700' }}>
               Asynchronously share music with your teammates, whether they&#39;re listening in real-time or catching back up on your recommendation after a meeting.
              </Text>
            </Box>
          </Flex>
        </Container>
          ...
          <Flex sx={{ flexDirection: ['column', 'row'], flexWrap: 'wrap' }}>
            ...
            <Box sx={{ flex: [1, '50%', '25%'], px: 2, py: [2, 2, 0] }}>
              ...
              >
                ...
                <Text sx={{color: 'gray600', fontSize: 2}}>
                  Tag and organize your music so it's easier to find and recommend or play a song for your co-workers.
                </Text>
              </Box>
            </Box>
            ...
            <Box sx={{ flex: [1, '50%', '25%'], px: 2, py: [2, 2, 0] }}>
              ...
              >
                ...
                <Text sx={{color: 'gray600', fontSize: 2}}>
                  Chat comments are tied to each song, so you can relive the disucssion when you get back from a meeting.
                </Text>
              </Box>
            </Box>
            ...
            <Flex sx={{flexDirection: ['column', 'row']}}>
              ...
              >
                <Text sx={{color: 'indigo100', fontSize: [3, 4], lineHeight: 1.5, mb: 4, zIndex: 1}}>
                  Musicbox has been a great way to maintain and build personal relationships with my colleagues. Building playlists with my team and listening to music together throughout the day has not only introduced me to new music, it has also helped me connect with my teammates in ways I didn't expect.
                </Text>
                <Box
                  as='cite'
                  sx={{
                ...
                >
                  <Text sx={{display: 'block', color: 'indigo100', fontSize: [3,4], fontWeight: '600', fontStyle: 'normal'}}>Spencer Bean</Text>
                  <Text sx={{display: 'block', color: 'indigo200', fontSize: [3,4], fontWeight: '400', fontStyle: 'normal'}}>Operations Manager</Text>
                </Box>
              </Flex>
              ...
              >
                <Text sx={{color: 'indigo100', fontSize: [3, 4], mb:4, lineHeight: 1.5, zIndex: 1}}>Musicbox makes work more fun. When my friends and I are using Musicbox, we get to learn about each other, learn about new songs we like (or hate), and keep focused on getting the job done...together.</Text>
                <Box
                  as='cite'
                  sx={{
                    display: 'block',
                ...
                >
                  <Text sx={{display: 'block', color: 'indigo100', fontSize: [3,4], fontWeight: '600', fontStyle: 'normal'}}>Jason Sisk</Text>
                  <Text sx={{display: 'block', color: 'indigo200', fontSize: [3,4], fontWeight: '400', fontStyle: 'normal'}}>Engineering Manager</Text>
                </Box>
              </Flex>
            </Flex>
          </Box>
